# Business Model: Independent Public-Sector Market-Entry & Procurement Compliance Service — Russian Federation

## Classification

- Repository: `cloud-itonami-iso3166-rus`
- ISO 3166: `RUS` (Russian Federation)
...
- an already-incorporated `cloud-itonami-cofog-{code}` /
  ...
  `cloud-itonami-{ISIC}` operator wanting to bid on a Russian
  public contract
...
- registration walkthrough for the Unified Information System for Procurement (ЕИС, zakupki.gov.ru) under 44-FZ / 223-FZ
- business/tax registration checklist: OGRN/INN registration via the Federal Tax Service (ФНС) and participation credentials on zakupki.gov.ru
- local-content / preferential-procurement navigation: no blanket local-content quota equivalent to Buy American, but 44-FZ/223-FZ procedures and FAS oversight impose distinct registration and bid-security rules
...
- this service does **not** provide legal or tax advice; characterization
  ...
  routes to Russian-licensed counsel or a registered agent
...
- **`cloud-itonami-cofog-{code}`**: a jurisdiction-agnostic operator
  ...
  blueprint AND this one to operate in Russia).
