# cloud-itonami-iso3166-rus

Open ISO 3166 Blueprint for **RUS**: Russian Federation.
...
tax registration, and local-content rules in Russia, so the operator
...
- **Not the government of Russia.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Russian-licensed counsel
...
(ISO 3166 `RUS`). Required capabilities:
