(ns marketentry.store
  "SSoT for the RUS market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems RU" :portal "EIS/zakupki.gov.ru"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ru-entity? true :has-ru-entity? true
             :requires-inn? true :inn-verified? true
             :drafted? false :submitted? false
             :jurisdiction "RUS" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "EIS/zakupki.gov.ru"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ru-entity? true :has-ru-entity? true
             :requires-inn? true :inn-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "EIS/zakupki.gov.ru"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "RUS" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "EIS/zakupki.gov.ru"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ru-entity? true :has-ru-entity? false
             :requires-inn? true :inn-verified? true
             :drafted? false :submitted? false
             :jurisdiction "RUS" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "EIS/zakupki.gov.ru"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ru-entity? true :has-ru-entity? true
             :requires-inn? true :inn-verified? false
             :drafted? false :submitted? false
             :jurisdiction "RUS" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "EIS/zakupki.gov.ru"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-ru-entity? has-ru-entity?
                               requires-inn? inn-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ru-entity?)  (assoc :engagement/requires-ru-entity? requires-ru-entity?)
    (some? has-ru-entity?)       (assoc :engagement/has-ru-entity? has-ru-entity?)
    (some? requires-inn?)    (assoc :engagement/requires-inn? requires-inn?)
    (some? inn-verified?)    (assoc :engagement/inn-verified? inn-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ru-entity? :engagement/has-ru-entity?
   :engagement/requires-inn? :engagement/inn-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ru-entity? (boolean (:engagement/requires-ru-entity? m))
     :has-ru-entity? (boolean (:engagement/has-ru-entity? m))
     :requires-inn? (boolean (:engagement/requires-inn? m))
     :inn-verified? (boolean (:engagement/inn-verified? m))
